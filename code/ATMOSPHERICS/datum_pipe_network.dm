...
datum/pipe_network
	...
	proc/reconcile_air()
		...
		for(var/datum/gas_mixture/gas in gases)
			...
			air_transient.plasma += gas.plasma
		...
		if(air_transient.volume > 0)
			...
			for(var/datum/gas_mixture/gas in gases)
				...
				gas.plasma = air_transient.plasma*gas.volume/air_transient.volume
...
proc/equalize_gases(datum/gas_mixture/list/gases)
	...
	if(total_volume > 0)
		...
		for(var/datum/gas_mixture/gas in gases)
			...
			gas.plasma = total_plasma*gas.volume/total_volume

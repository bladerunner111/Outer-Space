...
obj/machinery/atmospherics/pipe/tank/plasma
	...
	New()
		...
		air_temporary.plasma = (25*ONE_ATMOSPHERE)*(air_temporary.volume)/(R_IDEAL_GAS_EQUATION*air_temporary.temperature)
...
obj/machinery/atmospherics/pipe/tank/attackby(var/obj/item/weapon/W as obj, var/mob/user as mob)
	if (istype(W, /obj/item/device/analyzer) && get_dist(user, src) <= 1)
		...
		if (total_moles>0)
			...
			var/plasma_concentration = parent.air.plasma/total_moles

...
/obj/machinery/power/rad_collector/attack_hand(mob/user as mob)
	if(anchored)
		if(!src.locked)
			...
			investigate_log("turned [active?"<font color='green'>on</font>":"<font color='red'>off</font>"] by [user.key]. [P?"Fuel: [round(P.air_contents.plasma/0.29)]%":"<font color='red'>It is empty</font>"].","singulo")
			return
		else
...
/obj/machinery/power/rad_collector/proc/receive_pulse(var/pulse_strength)
	if(P && active)
		...
		power_produced = P.air_contents.plasma*pulse_strength*20
